...
void testBinarySort()
{
	...
	*(arrayTestSort2+4) = 4;
	...
	if (flag == 1)
		printf("Test (sort of array with filter) is correct.\n");
	else
		printf("Error. Test incorrect.\n");
...
void testFilter()
{
	...
	*(arrayFilterTest2+4) = -5;
	...
	if (flag == 1)
		printf("Test (filter array function) is correct.\n");
	else
		printf("Error. Test incorrect.\n");
